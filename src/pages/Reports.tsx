...
import { FileText, Download, Calendar, TrendingUp, AlertTriangle, Activity, CheckCircle2, Sparkles } from 'lucide-react'
    ...
    <DashboardLayout>
      <header className="bg-white border-b border-slate-200/90 px-6 py-4 shadow-sm sticky top-0 z-20">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">Executive Reports & Intelligence Insights</h1>
            <p className="text-xs text-slate-500 mt-0.5">Automated daily civic summaries, pavement degradation audits, and safety analytics</p>
          </div>
          <div className="flex items-center space-x-3">
            <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200 flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" />
              AI Daily Briefing Ready
            </span>
            <HeaderActions />
          </div>
        </div>
      ...
      <div className="flex-1 overflow-auto p-6 bg-slate-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <button className="bg-white border border-slate-200/90 rounded-2xl p-6 hover:border-blue-300 hover:shadow-card-hover transition-all text-left shadow-card group">
          ...
          <button className="bg-white border border-slate-200/90 rounded-2xl p-6 hover:border-emerald-300 hover:shadow-card-hover transition-all text-left shadow-card group">
          ...
          <button className="bg-white border border-slate-200/90 rounded-2xl p-6 hover:border-indigo-300 hover:shadow-card-hover transition-all text-left shadow-card group">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 mb-6 shadow-card">
          <div className="flex flex-wrap items-center justify-between pb-4 mb-6 border-b border-slate-100 gap-2">
            <div>
              <span className="text-[11px] font-extrabold text-blue-600 uppercase tracking-wider block">Autonomous Synthesis</span>
              <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">DAILY CITY INTELLIGENCE BRIEF</h2>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-slate-50/80 border border-slate-200/80 rounded-xl p-5 hover:bg-white transition-colors">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl overflow-hidden shadow-card">
          <div className="px-6 py-4 border-b border-slate-200/80 bg-slate-50/60 flex items-center justify-between">
            <h3 className="font-extrabold text-slate-900 text-sm uppercase tracking-wider">HISTORICAL CITY INTELLIGENCE ARCHIVES</h3>
            <span className="text-xs font-semibold text-slate-500">Past 30 Days</span>
          </div>
          ...
          <div className="p-6 space-y-3">
            {[
              ...
              <div key={index} className="flex flex-wrap items-center justify-between p-4 bg-slate-50/70 border border-slate-200/70 rounded-xl hover:bg-white hover:border-blue-200 transition-all cursor-pointer shadow-sm">
